...
SECRET_KEY = 'django-insecure-!-_i1%x&)_o4ftis8(i#=k+7w99yu9@ua+92g&h%)#5v@h-i6!'
...
MATERIAL_ADMIN_SITE = {
    'HEADER':  'Only Python',  # Admin site header
    'TITLE':  'Only Python Admin Panel',  # Admin site title
